...
// ── Static data (never mutated, no need for state) ──────────────────────────
const problems: Problem[] = (problemsData as ProblemsData).problems;
const codeTemplates: CodeTemplates = (problemsData as ProblemsData).codeTemplates;
 ...
 */
  ...
  }, [currentProblemId, languageId, codeTemplates, setCode, setOutput, setTestResults, setSelectedTestCase]);
